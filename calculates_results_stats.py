...
def calculates_results_stats(results_dic):
    ...
    """        
    # defining a dictionary for all measures that need to be calculated
    label_matches = 0
    results_stats_dic = dict([('n_images',0),('n_dogs_img',0),('n_notdogs_img',0),('n_match',0),('n_correct_dogs',0),('n_correct_notdogs',0),('n_correct_breed',0),('pct_match',0.0),('pct_correct_dogs',0.0),('pct_correct_breed',0.0),('pct_correct_notdogs',0.0)])
    #iterating through results_dic to populate values(number of matches) for the measures 
    ...
    # returning updated dictionary to the caller
